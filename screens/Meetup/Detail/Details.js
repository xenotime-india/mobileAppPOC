      ...
      >
        <Container>
            ...
            <List>
              ...
              <ListItem>
                <Body>
                  ...
                  <CheckBox checked={true} color="#4b5487" />
                </Body>
              </ListItem>
              <ListItem>
                <Body>
              ...
              <ListItem>
                ...
                {primaryTeacherPic && (
                  <Right>
                    <Avatar source={primaryTeacherPic || defaultPic} />
                  </Right>
                )}
              </ListItem>
              <ListItem>
                ...
                {organizerName && (
                  <Right>
                    <Avatar source={organizerPic || defaultPic} />
                  </Right>
                )}
              </ListItem>
              <ListItem>
                ...
                {coTeacher1Pic && (
                  <Right>
                    <Avatar source={coTeacher1Pic || defaultPic} />
                  </Right>
                )}
              </ListItem>
              <ListItem>
                ...
                {coTeacher2Name && (
                  <Right>
                    <Avatar source={coTeacher2Pic || defaultPic} />
                  </Right>
                )}
              </ListItem>
            </List>
          ...
          >
            ...
            <Button
              style={{ backgroundColor: '#4b5487' }}
              onPress={() => this.props.navigation.navigate('NewMeetup')}
            >
        ...
        <QRCodeScanner modalVisible={this.state.modalVisible} />
      </View>
    );
  }
}
